...
<head>
	...
	<title>Certificate of Residency -  Barangay Management System</title>
    <style>
        @page  
        { 
								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="text-center">
                                                <h1 class="mt-4 fw-bold mb-5">CERTIFICATE OF RESIDENCY</h1>
                                            </div>
                                            <h2 class="mt-5">To whom it may concern:</h2>
                                            <h2 class="mt-3" style="text-indent: 40px;">This is to certify that <span class="fw-bold" style="font-size:25px"><?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></span>, <?= ucwords($resident['citizenship']) ?>
												citizen whose specimen signature appears below, is a <b>RESIDENT</b> of this Barangay.
                                            <span style="font-size:25px">Based on records of this office, She / He has been residing at <?= ucwords($brgy) ?></span>.</h2>
                                            <h2 class="mt-3" style="text-indent: 40px;">This certification is being issued upon the request of the aboved-named person for whatever legal purpose it may serve.</h2>
											
										
                                            <h2 class="mt-5">Issued this <span style="font-size:25px"><?= date('m/d/Y') ?> at <?= ucwords($brgy) ?>,<?= ucwords($province) ?>, Philippines</span> </h2>
                                            
                                        </div>
                                        <div class="col-md-12">
                                            <div class="p-3 text-right mr-3">
                                                <h2 class="fw-bold mb-0 text-uppercase"><?= ucwords($captain['name']) ?></h2>
                                                <p class="mr-3">Barangay Captain</p>
                                            </div>
