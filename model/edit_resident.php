	...
	if($nat['id'] == $id || count($nat) <= 0){
		if(!empty($id)){
			...
			if(!empty($profile) && !empty($profile2)){
				...
				$query = "UPDATE tblresident SET email='$email',citizenship='$citi',`picture`='$profile', `firstname`='$fname', `middlename`='$mname', `lastname`='$lname', `birthplace`='$bplace', `birthdate`='$bdate', 
						age=$age, `civilstatus`='$cstatus', `gender`='$gender', `purok`='$purok', `contact`='$contact',`occupation`='$occu', `address`='$address'
						WHERE id=$id;";
				...
				$query = "UPDATE tblresident SET email='$email',citizenship='$citi',`picture`='$newName', `firstname`='$fname', `middlename`='$mname', `lastname`='$lname',`birthplace`='$bplace', `birthdate`='$bdate', 
							age=$age, `civilstatus`='$cstatus', `gender`='$gender', `purok`='$purok', `contact`='$contact',`occupation`='$occu', `address`='$address'
							WHERE id=$id;";
				...
				$query = "UPDATE tblresident SET email='$email',citizenship='$citi',`firstname`='$fname', `middlename`='$mname', `lastname`='$lname', `birthplace`='$bplace', `birthdate`='$bdate', 
							age=$age, `civilstatus`='$cstatus', `gender`='$gender', `purok`='$purok', `contact`='$contact',`occupation`='$occu', `address`='$address'
							WHERE id=$id;";
