...
<head>
	...
	<title>Certificate of Cohabitation -  Barangay Management System</title>
    <style>
        @page  
        { 
                            ...
                            <div class="card" style ="outline-style:solid; outline-color:maroon">
								<div class="card-header" style ="outline-style:solid; outline-color:maroon">
									<div class="card-head-row">
										<div class="card-title"><b>Certificate of Cohabitation</b></div>
								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="text-center">
                                                <h1 class="mt-4 fw-bold mb-5">Certificate of Cohabitation</h1>
                                            </div>
                                            <h2 class="mt-5">Sa Kinauukulan:</h2>
                                            <h2 class="mt-3" style="text-indent: 40px;">Ito po ay pagpapatunay na si <span class="fw-bold" style="font-size:25px"><u><?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></u></span> , 
												pawang nasa hustong gulang ng <?= ucwords($brgy) ?>, <?= ucwords($province) ?> ay nagsasama ng taon bilang mag-asawa ngunit hindi pa naikakasal.
                                            <span style="font-size:25px">Pinalabas ang pagpapatunay na ito upang magamit sa anumang legal na bagay hindi pang sariling kapakanan kundi naaayon sa umiiral na batas.</h2>
                                            
											
										
                                            <h2 class="mt-5">Isinagawa ngayong <span style="font-size:25px"><?= date('m/d/Y') ?></span> </h2>
                                            <h2 class="mt-12">Patotoo: </h2>
                                        </div>
                                        <div class="col-md-12">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_pment.php" >
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="Enter Payment Details" name="details">Certificate of Cohabilitation Payment</textarea>
                                </div>
                        </div>
