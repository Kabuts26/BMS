                            ...
                            <div class="card" style ="outline-style:solid; outline-color:maroon">
								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-9">
                                            <div class="text-center">
                                                <h2 class="mt-4 fw-bold">TANGGAPAN NG PUNONG BARANGAY</h2>
                                            </div>
                                            <div class="text-center">
                                                <h1 class="mt-4 fw-bold mb-5">CERTIFICATE OF INDIGENCY</h1>
                                            </div>
                                           <h2 class="mt-5">Sa Kinauukulan: </h2>
                                            <h2 class="mt-3" style="text-indent: 40px;">Ito po ay pagpapatunay na si <span class="fw-bold" style="font-size:25px"><?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></span>, nasa
												hustong gulang ay residente ng
                                            <span class="fw-bold" style="font-size:25px"><?= ucwords($brgy) ?></span>.</h2>
                                            <h2 class="mt-3" style="text-indent: 40px;">Ito po ay pagpapatunay na sila ay <b>nabibilang sa mababang antas(Indigency)</b> ng pamumuhay sa lipunan</h2>
											<h2 class="mt-3" style="text-indent: 40px;">Pinalabas ang pagpapatunay na ito upang magamit sa anumang legal na bagay hindi pang sariling kapakanan kundi naayon sa umiiral na batas.</h2>
										
                                            <h2 class="mt-5">Isinagawa ngayong <span class="fw-bold" style="font-size:25px"><?= date('m/d/Y') ?>.</span></h2>

                                            <div class="p-3 text-right mr-3">
											 <h2 style="margin-top:180px; margin-right:200px">Patotoo:</h2><br><br><br>
                                                <h2 class="fw-bold mb-0 text-uppercase"><?= ucwords($captain['name']) ?></h2>
                                                <p class="mr-3">PUNONG BARANGAY</p>
                                            </div>
											<br><br><br>
											<img src="assets/img/yellow-circle.png" style="height:300px; width:300px; margin-left:450px">
                                        </div>
