...
if(isset($_POST['submit'])){
    ...
    $messageBird = new \MessageBird\Client('55DSiNZBhV9ivaLzPzQCx29Av');
    $message =  new \MessageBird\Objects\Message();
    try{

        $message->originator = '+639109998752';
...
<!--<img src="logo1.jpg" style="width:100px; height:100px; margin-left: 690px" >-->

<button onclick="window.location.href='../dashboard.php'">Previous</button>
