				...
				<div class="panel-header" style="color:black">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-black fw-bold" style="font-size:40px ">Certificate of Cohabitation</h2>
							</div>
						</div>
					</div>
				</div>
                            ...
                            <div class="card" style ="outline-style:solid; outline-color:maroon;">
								<div class="card-header" style ="outline-style:solid; outline-color:maroon;">
									<div class="card-head-row">
										<div class="card-title">Resident Certificate of Cohabitation</div>
									</div>
								</div>
								<div class="card-body">
													...
													<tr>
														...
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" href="generate_cohabitation_cert.php?id=<?= $row['id'] ?>" class="btn btn-link btn-primary" data-original-title="Generate Certificate">
